...
- No longer require the unauthenticated webhook provider port to be exposed for health probes ([#????](https://github.com/kubernetes-sigs/external-dns/pull/????)) _@kimsondrup_
